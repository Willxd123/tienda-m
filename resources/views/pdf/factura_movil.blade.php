    ...
    <div>
        <div class="py-4">
                                    ...
                                    <table class="border-collapse border-spacing-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pl-4">
                                                    <div>
                                                        <p class="whitespace-nowrap text-slate-400 text-right">Factura #
                                                        </p>
                                                        <p class="whitespace-nowrap font-bold text-main text-right">
                                                            000025</p>
                                                    </div>
                        ...
                        <tr>
                            <td class="w-1/2 align-top">
                                <div class="text-sm text-neutral-600">
                                    <p class="font-bold">Confy Home Promotora</p>
                                    <p>Contacto: 63449745</p>
                                    <p>NIT: 23456789</p>
                                    <p></p>
                                    <p>Calle Falsa 123</p>
                    ...
                    <tbody>
                        ...
                        @foreach ($productos as $producto)
                            <tr>
                                ...
                                <td class="border-b py-3 pl-2">{{ $producto['nombre'] }}</td>
            ...
            <div class="px-14 text-sm text-neutral-700">
                ...
                <p>Pago online con tarjeta VISA</p>
                <p></p>
                <p></p>
                <p></p>
            </div>
            ...
            <div class="px-14 py-10 text-sm text-neutral-700">
                <p class="text-main font-bold"></p>
                <p class=>Esta factura contribuye al desarrollo del país, el uso ilícito será sancionado penalmente de
                    acuerdo a la Ley.</p>
            </div>

            <div class="px-14 text-sm text-neutral-700">
                <p class="text-main font-bold"></p>
                <p class="italic">Ley Nº 453. El proveedor debe brindar atención sin discriminación, con respeto,
                    calidez y cordialidad a los usuarios y consumidores</p>
            </div>
