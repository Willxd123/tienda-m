            ...
            <footer class="bg-{{ $color->color }}">
                <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div class="md:flex md:justify-between">
                        <div class="mb-6 md:mb-0 px-8 ">
                            <a href="/" class="flex flex-col text-custom-blue-gray-300">
                                <div class="h-28 w-30">
                                    <img src="{{ $configuracion->logotipo }}" alt="" class="h-28 w-full">
                                </div>
                        ...
                        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                <h2 class="mb-6 text-sm font-semibold text-custom-blue-gray-300 uppercase ">Resources
                                </h2>
                            ...
                            <div>
                                <h2 class="mb-6 text-sm font-semibold text-custom-blue-gray-300 uppercase ">Follow us
                                </h2>
